  ...
  return (
    ...
    >
      <Transition
        ...
        leaveTo="opacity-0"
      >
        <div className=" absolute md:max-h-[85vh] max-h-[65vh] overflow-y-scroll flex flex-col bg-white max-w-xl my-auto md:mx-auto inset-0 mx-2 px-2 md:px-6   rounded-md ">
